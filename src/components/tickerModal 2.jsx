...
const TickerModal = props => {
    if(props.modal != null){
        ...
        return (
            <div className={props.modal.status} id="exampleModal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title m-auto" id="exampleModalLongTitle">{modalData.name + " " + modalData.symbol}</h5>
                            <img src={this.props.coinMetaData}/>
                        </div>
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary m-auto" data-dismiss="modal" onClick={props.handleModal}>Close</button>
                        </div>
                    </div>
                </div>
            </div>
